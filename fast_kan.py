...
# From: https://github.com/ZiyaoLi/fast-kan
...
class AttentionWithFastKANTransform(nn.Module):
    ...
    def __init__(
        ...
        self.gating = gating
        self.linear_q = Fast_KANLinear(q_dim, total_dim)
        self.linear_k = Fast_KANLinear(k_dim, total_dim)
        self.linear_v = Fast_KANLinear(v_dim, total_dim)
        self.linear_o = Fast_KANLinear(total_dim, q_dim)
        self.linear_g = None
        if self.gating:
            self.linear_g = Fast_KANLinear(q_dim, total_dim)
